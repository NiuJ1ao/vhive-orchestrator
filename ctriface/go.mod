...
require (
	...
	github.com/ustiugov/fccd-orchestrator/memory/manager v0.0.0-20200821104645-51e42c38cf31
	github.com/ustiugov/fccd-orchestrator/metrics v0.0.0-20200817173503-042e167f1389
