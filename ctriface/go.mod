...
require (
	...
	github.com/ustiugov/fccd-orchestrator/memory/manager v0.0.0-20200819110152-c5628d4d4565
	github.com/ustiugov/fccd-orchestrator/metrics v0.0.0-20200818101957-fe613a2922fd
