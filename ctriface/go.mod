...
replace github.com/firecracker-microvm/firecracker-containerd => github.com/ustiugov/firecracker-containerd v0.0.0-20200815202627-690b0450184d
...
require (
	...
	github.com/ustiugov/fccd-orchestrator/memory/manager v0.0.0-20200815203226-4fafcae8b5ad
